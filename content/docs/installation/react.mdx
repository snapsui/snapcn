---
title: React.js
description: Install and configure Sanp UI for React.js
published: true
---
...
Here's what `tailwind.config.js` file looks like:
...
You can now start adding [components](/snapui) to your project.
