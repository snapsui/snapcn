---
title: Next.js
description: Install and configure Snap UI for Next.js
published: true
---
...
Run the `snapcn` init command to setup your project:
...
export default function Input() {
  return (
    <div>
      <SnapInput type="email" placeholder="Enter email..." />
    </div>
  );
}
```
