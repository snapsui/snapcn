...
export const init = new Command()
  .name("init")
  .description("Initialize your project with shadcn-ui config & snap-ui")
  ...
  .action(async (opts) => {
    try {
      ...
      logger.info(
        `${chalk.green(
          "Success!",
        )} Project initialization completed. You may now add both shadcn-ui and snap-ui components.`,
      );
      logger.info("");
    } catch (error) {
      handleError(error);
